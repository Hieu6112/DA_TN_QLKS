...
namespace DATN_QLKS.Areas.Admin.Controllers
{
    public class LoaiPhongController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "mo_ta,gia,ti_le_phu_thu,anh,chi_tiet_phong")] tblLoaiPhong tblLoaiPhong)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "loai_phong,mo_ta,gia,ti_le_phu_thu,anh,chi_tiet_phong")] tblLoaiPhong tblLoaiPhong)
        {
            if (ModelState.IsValid)
            {
                if (tblLoaiPhong.anh == null)
